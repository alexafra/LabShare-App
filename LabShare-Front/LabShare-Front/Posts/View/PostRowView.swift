...
struct PostRow_Previews: PreviewProvider {
    static var previews: some View {
        PostRowView(postVM: PostViewModel(post: PostModel(id: 10, title: "Free Iphonlwkjeq lwkej qlwkej lqkwje qlkwej lkqwje lkqwje lkqwje lkqwj elqwkjel kqwje lqwkjelqwkje kqwkje lqkwje lkqwje lkqwje es", content: "I would like to give away 10 iphones I would like to give away 10 iphones I would like to give away 10 iphones I would like to give away 10 iphones I would like to give away 10 iphones", dateCreated: Date(), category: CategoryEnum.Reagents, author: UserModel (id: 37, email: "alexanderfrazis@gmail.com", firstName: "Alexander", lastName: "Frazis"))))
